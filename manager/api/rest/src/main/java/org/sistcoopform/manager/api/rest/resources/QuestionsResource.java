...
public interface QuestionsResource {
	...
	@Path("{questionId}")
	public SectionResource pregunta(@PathParam("questionId") String questionId);
	...
	@GET
	@Produces(MediaType.APPLICATION_JSON)
	public List<SectionRepresentation> search(@QueryParam("title") String title,
			@QueryParam("number") int number, @QueryParam("filterText") String filterText,
			@QueryParam("first") Integer firstResult, @QueryParam("max") Integer maxResults);

	@POST
	@Path("search")
	@Produces(MediaType.APPLICATION_JSON)
	public SearchResultsRepresentation<SectionRepresentation> search(SearchCriteriaRepresentation criteria);
