...
public class PreguntaTiempoAdapter implements PreguntaTiempoModel {
    ...
    public PreguntaTiempoAdapter(EntityManager em, PreguntaTiempoEntity preguntaTiempoEntity) {
        this.em = em;
    ...
    public static PreguntaTiempoEntity toPreguntaTiempoEntity(SeccionModel model, EntityManager em) {
        if (model instanceof PreguntaTiempoAdapter) {
            return ((PreguntaTiempoAdapter) model).getPreguntaTiempoEntity();
        }
    ...
    @Override
    public TipoPreguntaTiempo getTipoPregunta() {
        return TipoPreguntaTiempo.valueOf(preguntaTiempoEntity.getTipoPregunta());
    }

    @Override
    public void setTipoPregunta(TipoPreguntaTiempo tipoPregunta) {
